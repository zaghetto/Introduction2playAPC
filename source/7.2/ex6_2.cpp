...
int main(){
    ...
    int imgfundo, imgheroi1, imgheroi2, imgvilao1, imgvilao2;
	...
	imgheroi2 = AbreImagem("./heroi2.png");
    imgvilao1 = AbreImagem("./vilao1.png");
    imgvilao2 = AbreImagem("./vilao2.png");
    ...
    if(colisaoVilao){
        AssociaImagem(imgheroi2, QUADRADO, heroi);
        AssociaImagem(imgvilao2, QUADRADO, vilao);
    }
